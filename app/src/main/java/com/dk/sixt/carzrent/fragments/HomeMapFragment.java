...
public class HomeMapFragment extends Fragment implements OnMapReadyCallback {
     ...
     */
    public static HomeMapFragment newInstance(List<Cars> carsList, String param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            carsList = getArguments().getParcelableArrayList(ARG_PARAM1);
    ...
    private void updateLocationUI() {
        ...
        if (mMap != null && mCurrentLocation != null) {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(getActivity().getResources(),
                    R.mipmap.user_icon);
            mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap)).position(current).title("You"));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(current));
            mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(current, 10), 1500, null);
    ...
    private void displayCarsOnMap() {
        if (carsList == null)
            return;

        for (Cars cars : carsList) {
            LatLng carPosition = new LatLng(cars.getLatitude(), cars.getLongitude());
            addMarkers(cars, carPosition);
        }


    }

    private void addMarkers(final Cars cars, final LatLng carPosition) {
        Target target = new Target() {
            ...
            public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                ...
                mMap.addMarker(new MarkerOptions().draggable(false)
                        .icon(BitmapDescriptorFactory.fromBitmap(bitmap)).position(carPosition).title(cars.getName()));
            }
        ...
        Picasso.with(getContext()).load(cars.getCarImageUrl()).resize(50, 50).into(target);
    }
...
//                .setAction(getString(actionStringId), listener).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == MainActivity.MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION) {
